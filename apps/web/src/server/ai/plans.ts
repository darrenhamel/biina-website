...
const FALLBACK_FREE: Plan = {
  ...
  imageUploadsPerDay: null,
  ocrEnabled: false,
  ocrPagesPerMonth: null,
  speechToTextEnabled: false,
  audioMinutesPerMonth: null,
  textToSpeechEnabled: false,
  ttsCharactersPerMonth: null,
  ...
  ssoEnabled: false,
  scimEnabled: false,
  dedicatedProviderAllowed: false,
  dataResidencyControls: false,
  auditExportEnabled: false,
  customRolesEnabled: false,
  maxOrganizationGroups: null,
  maxCustomRoles: null,
  priorityClass: 100,
