...
/** Admin → AI Control. Authorization enforced server-side (not just hidden nav). */
export const dynamic = 'force-dynamic';

export default async function AiControlPage({ params }: { params: { locale: string } }) {
    ...
    return (
      <div className="grid h-full place-items-center px-6 text-center">
        <div className="max-w-sm">
          ...
          <h1 className="mt-4 text-xl font-bold text-ink">{dict.admin.aiControl}</h1>
