...
import { AdminUsagePanel } from '@/components/app/AdminUsagePanel';

export const dynamic = 'force-dynamic';

export default async function AdminUsagePage({ params }: { params: { locale: string } }) {
    ...
    return (
      <div className="grid h-full place-items-center px-6 text-center">
        <div className="max-w-sm">
          ...
          <h1 className="mt-4 text-xl font-bold text-ink">{dict.admin.usageCost}</h1>
